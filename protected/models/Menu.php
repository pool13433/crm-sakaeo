...
class Menu extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('menu_id, menu_name, menu_desc,menu_href, menu_date,menu_status', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('menu_date', $this->menu_date, true);
