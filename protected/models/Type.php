...
class Type extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('type_code,type_name, type_date, type_min_price, type_points, type_status', 'required'),
            ...
            array('type_code,type_id, type_name, type_date, type_min_price, type_points, type_status', 'safe', 'on' => 'search'),
        );
    }
